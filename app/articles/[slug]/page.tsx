...
const BASE_URL = "https://taiwan-futures-calculator.vercel.app";
const SITE_NAME = "Vertex Futures Calculator";
...
export async function generateMetadata({
  ...
  const modifiedDate = normalizeDate(article.updatedAt);
...
export default async function ArticlePage({ params }: PageProps) {
  ...
  return (
    <>
      ...
      <script
        id={`breadcrumb-json-ld-${article.slug}`}
        type="application/ld+json"
        dangerouslySetInnerHTML={{
                ...
                <div className="relative px-6 py-8 sm:px-8 md:px-10 md:py-11">
                  ...
                  <div className="relative">
                    ...
                    <div className="mt-7 flex flex-wrap items-center gap-x-6 gap-y-3 text-sm font-medium text-slate-500">
                      ...
                      <span>作者：Vertex Futures Calculator</span>
                    </div>
                  </div>
                </div>
